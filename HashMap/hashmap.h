...
public:
    ...
    */
    M& at(const K& key);
    const M& at(const K& key) const; // add const version for at
    ...
    */
    ...
    // add const end() for hashmap copy constructor
    ...
    */
    ...
    // std::ostream& operator<<(std::ostream& stream, const HashMap& map);
    ...
    */
    struct Node
    {
        ...
        */
        ...
        Node(const value_type& val, Node* next_node) : value(val), next(next_node) {};
    };
