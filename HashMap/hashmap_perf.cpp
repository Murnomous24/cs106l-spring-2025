...
void benchmark_insert_erase() {
    ...
    for (size_t size : sizes) {
        ...
        size_t my_map_result, std_map_result;
        {
            ...
            HashMap<int, int, decltype(good_hash_function)> my_map(500000, good_hash_function);
...

        {
            ...
            std::unordered_map<int, int, decltype(good_hash_function)> std_map(500000, good_hash_function);
            for (int element : million) {
