...
main(int argc, char* argv[])
{
  ...
  if (argc == 2) {
    ...
    ********************************************************/
    ...
    auto op1 = [](std::optional<Course> c) -> std::optional<std::string> {
        return "Found course: " + c.value().title + "," + c.value().number_of_units + "," + c.value().quarter;
    };

    auto op2 = []() -> std::optional<std::string> {
